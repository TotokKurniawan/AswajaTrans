...
<body>
  ...
  <script>
    document.getElementById('nopol').addEventListener('change', function() {
      ...
      var harga = <?php echo json_encode($_SESSION['harga_data']); ?>[selectedNopol];
      document.getElementById('harga').value = harga;
    });

    document.getElementById('lamapinjam').addEventListener('input', function() {
      var harga = document.getElementById('harga').value;
      var lamaPinjam = this.value;
      var totalHarga = harga * lamaPinjam;
